    ...
    <>
      ...
      <div className='flex h-screen'>
        ...
        <div className='bg-discord_channelsBG flex flex-col min-w-max'>
            <h2 className='flex text-white font-bold text-sm items-center justify-between border-b border-gray-800 p-4
            hover:bg-discord_serverNameHoverBg cursor-pointer'>Official PAPA Server...<ChevronDownIcon className='h-5 ml-2'/></h2>
